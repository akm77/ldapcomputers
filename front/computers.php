...
Html::header(PluginLdapcomputersComputers::getTypeName(Session::getPluralNumber()), $_SERVER['PHP_SELF'], 'admin', 'pluginldapcomputerscomputers', 'ldapcomputerscomputers');

$config = new PluginLdapcomputersComputers();
Search::show('PluginLdapcomputersComputers');
