...
Html::header(PluginLDAPcomputersLDAPcomputers_config::getTypeName(Session::getPluralNumber()), $_SERVER['PHP_SELF'], 'config', 'auth', 'ldap');

Search::show('PluginLDAPcomputersLDAPcomputers_config');
