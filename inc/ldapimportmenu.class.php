...
class PluginLdapcomputersLdapimportmenu extends CommonGLPI {
   ...
   static function getMenuName() {
      return __("Import LDAP computers", "ldapcomputers");
   }
   ...
   static function getMenuContent() {
      ...
      $menu['page']  = "$front_ldapcomputers/ldapimport.php";

      $itemtypes = ['PluginLdapcomputersLdapimportmenu' => 'ldapcomputers'];
